...
replaceitem entity @a hotbar.0 minecraft:armor_stand{EntityTag:{Tags:[new,size1],Glowing:1,ArmorItems:[{},{},{},{id:stone_button,Count:1}],Invisible:1,Marker:1},display:{LocName:"Spawn Body Mass 1",Lore:["Einstein's going to be mad!"]}} 1
...
replaceitem entity @a hotbar.2 minecraft:armor_stand{EntityTag:{Tags:[new,size3],Glowing:1,ArmorItems:[{},{},{},{id:gravel,Count:1}],Invisible:1,Marker:1},display:{LocName:"Spawn Body Mass 3",Lore:["Einstein's going to be mad!"]}} 1
replaceitem entity @a hotbar.3 minecraft:armor_stand{EntityTag:{Tags:[new,size5],Glowing:1,ArmorItems:[{},{},{},{id:stone,Count:1}],Invisible:1,Marker:1},display:{LocName:"Spawn Body Mass 5",Lore:["Einstein's going to be mad!"]}} 1
