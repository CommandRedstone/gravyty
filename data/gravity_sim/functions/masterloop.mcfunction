execute as @e[type=falling_block] run function gravity_sim:attracttome
...
execute as @e[type=armor_stand,tag=new] run function gravity_sim:summonsand

execute as @e[type=falling_block] run function gravity_sim:move