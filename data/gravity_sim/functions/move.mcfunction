...
execute store result entity @s Motion[0] double -0.00000001 run scoreboard players get @s xvelocity
execute store result entity @s Motion[1] double -0.00000001 run scoreboard players get @s yvelocity
execute store result entity @s Motion[2] double -0.00000001 run scoreboard players get @s zvelocity