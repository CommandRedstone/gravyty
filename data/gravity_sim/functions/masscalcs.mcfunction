execute store result score @s xrelative run data get entity @s Pos[0] 10
execute store result score @s yrelative run data get entity @s Pos[1] 10 
execute store result score @s zrelative run data get entity @s Pos[2] 10
